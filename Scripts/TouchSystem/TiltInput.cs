...
using UnityStandardAssets.CrossPlatformInput;
    ...
    public class TiltInput : MonoBehaviour
    {
		...
		public float sum = 0;
		public float negSum = 0;
		public float posSum = 0;

		public float average = 0;
		public float posAverage = 0;
		public float negAverage = 0;

		public static List<float> DevList = new List<float>();
	...
	void OnApplicationQuit()
		{
			...
			print("neg percentage" + (negSum / sum) * 100);
			print("pos percentage" + (posSum / sum) * 100);
			print(average + "av of ang");
		}
